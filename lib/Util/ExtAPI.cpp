      ...
      if (getEIPairs) {
        ...
        static const ei_pair ei_pairs[] = {
            ...
            {"__cxa_allocate_exception",
             ExtAPI::EFT_ALLOC}, // allocate an exception
            ...
            // FIXME: when arg0 is null, the return points into the string that
            // was
            ...
            {"_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_"
             "RS_",
             ExtAPI::EFT_STD_RB_TREE_INSERT_AND_REBALANCE},
            ...
            {"_ZNSt7__cxx1112basic_stringIcSt11char_"
             "traitsIcESaIcEEC1EPKcmRKS3_",
             ExtAPI::CPP_EFT_A0R_A1}, // c++11
            ...
            /// string constructor: string (const string &str, size_t pos,
            /// size_t
            /// len)
            ...
            {"_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_"
             "RKSbIS4_"
             "S5_T1_E",
